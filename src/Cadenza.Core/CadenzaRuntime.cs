// Cadenza Runtime Bridge - Provides system operation interfaces for Cadenza tools
// This allows Cadenza code to call .NET system functions for HTTP, file operations, etc.
