...
namespace Cadenza.Core
{
    ...
    /// </summary>
    public class ProductionBlazorGenerator
    {
        ...
        public string GenerateBlazorComponent(ComponentDeclaration component)
        {
            ...
            result.Append(_classContent.ToString());
        ...
        private void GenerateAttributeRenderTree(UIAttribute attr, string indent)
        {
            ...
            {
                _classContent.AppendLine($"{indent}builder.AddAttribute({attrSeq}, \"{attributeName}\", {identifier.Name});");
            }
