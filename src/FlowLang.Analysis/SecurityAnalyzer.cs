...
/// <summary>
/// Analyzer for FlowLang security best practices and vulnerability detection
/// </summary>
public class SecurityAnalyzer
{
    ...
    public class EffectLeakageRule : LintRule
    {
        ...
        private class EffectLeakageVisitor : ASTVisitor
        {
            ...
            {
                // In FlowLang, functions are public by default unless in a module with explicit exports
