...
{
    /// <summary>
    /// Provides intelligent auto-completion for FlowLang
    /// Supports keywords, identifiers, effects, Result types, and context-aware suggestions
    /// </summary>
    public class CompletionProvider
    {
        private static readonly CompletionItem[] FlowLangKeywords = new[]
        {
        ...
        private static readonly CompletionItem[] FlowLangTypes = new[]
        {
        ...
        private static readonly CompletionItem[] FlowLangEffects = new[]
        {
        ...
        private static readonly CompletionItem[] FlowLangConstructors = new[]
        {
        ...
        public CompletionList? GetCompletions(ManagedDocument document, Position position)
        {
            ...
            switch (context.Type)
            {
                case CompletionType.Keywords:
                    completions.AddRange(FlowLangKeywords);
                    break;

                case CompletionType.Types:
                    completions.AddRange(FlowLangTypes);
                    break;

                case CompletionType.Effects:
                    completions.AddRange(FlowLangEffects);
                    break;
                ...
                default:
                    completions.AddRange(FlowLangKeywords);
                    completions.AddRange(FlowLangTypes);
                    completions.AddRange(FlowLangConstructors);
        ...
        private static CompletionItem CreateKeywordCompletion(string keyword, string insertText = null, string documentation = null)
        {
            return new CompletionItem
            {
                ...
                Documentation = documentation ?? $"FlowLang '{keyword}' keyword",
        ...
        private static CompletionItem CreateTypeCompletion(string type, string insertText = null, string documentation = null)
        {
            return new CompletionItem
            {
                ...
                Detail = "FlowLang type",
                Documentation = documentation ?? $"FlowLang '{type}' type",
        ...
        private static CompletionItem CreateEffectCompletion(string effect, string documentation = null)
        {
            return new CompletionItem
            {
                ...
                Detail = "FlowLang effect",
                Documentation = documentation ?? $"FlowLang '{effect}' effect",
                InsertText = effect
            };
        }
        ...
        private static CompletionItem CreateConstructorCompletion(string constructor, string insertText, string documentation = null)
        {
            return new CompletionItem
            {
                ...
                Detail = "FlowLang constructor",
                Documentation = documentation ?? $"FlowLang '{constructor}' constructor",
