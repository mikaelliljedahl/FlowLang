// FlowLang Blazor Generator - Converts FlowLang UI components to Blazor components
// This generator creates .razor files from FlowLang component ASTs
...
namespace FlowLang.Tools
{
    /// <summary>
    /// Generates Blazor components from FlowLang UI component ASTs
    /// </summary>
    public class BlazorGenerator
    {
        ...
        /// <summary>
        /// Generates a Blazor component from a FlowLang ComponentDeclaration
        /// </summary>
        ...
        /// <summary>
        /// Generates Blazor markup from FlowLang render block
        /// </summary>
        ...
        {
            var tag = MapFlowLangElementToHtml(element.Tag);
        ...
        /// <summary>
        /// Generates Blazor attribute from FlowLang UIAttribute
        /// </summary>
        private void GenerateAttribute(UIAttribute attr)
        {
            var attributeName = MapFlowLangAttributeToBlazor(attr.Name);
        ...
        private void GenerateParameters(List<Parameter>? parameters)
        {
            ...
            {
                var blazorType = MapFlowLangTypeToBlazor(param.Type);
        ...
        private void GenerateStateDeclarations(List<StateDeclaration>? stateDeclarations)
        {
            ...
            {
                var blazorType = MapFlowLangTypeToBlazor(state.Type);
        ...
        /// <summary>
        /// Maps FlowLang element names to HTML tags
        /// </summary>
        private string MapFlowLangElementToHtml(string flowLangElement)
        {
        ...
        /// <summary>
        /// Maps FlowLang attributes to Blazor attributes
        /// </summary>
        private string MapFlowLangAttributeToBlazor(string flowLangAttribute)
        {
        ...
        /// <summary>
        /// Maps FlowLang types to Blazor/C# types
        /// </summary>
        private string MapFlowLangTypeToBlazor(string flowLangType)
        {
        ...
        /// <summary>
        /// Maps FlowLang effects to Blazor services
        /// </summary>
        ...
        /// <summary>
        /// Generates C# expression code from FlowLang AST
        /// </summary>
        ...
        private void GenerateStatements(ASTNode statement)
        {
            ...
            else if (statement is FunctionCall call)
            {
                ...
                {
                    // Handle FlowLang set_state calls
        ...
        /// <summary>
        /// Gets C# operator symbol from FlowLang operator
        /// </summary>
