...
/// <summary>
/// Automatic FlowLang binding generator for .NET libraries
/// </summary>
public class BindingGenerator
{
    ...
    /// <summary>
    /// Generate FlowLang bindings for a NuGet package
    /// </summary>
    public async Task<string> GenerateBindingsAsync(NuGetPackage package, Stream packageStream)
    {
        ...
        {
            $"// Generated FlowLang bindings for {package.Id} v{package.Version}",
            $"// Description: {package.Description}",
            "",
