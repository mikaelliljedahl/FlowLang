...
namespace ResultTest
{
    public class Result<T, E>
    {
        ...
        public E Error { get; private set; } = default(E)!;
        ...
        {
            return new Result<T, E> { Error = error, IsError = true };
        }
    }
    ...
    class Program
    {
        ...
        static void Main()
        {
            ...
            if (result2.IsError)
            {
                Console.WriteLine($"Error: {result2.Error}"); // Should print "Division by zero"
            }
            else
            {
