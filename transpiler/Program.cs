...
public class FlowLangParser
{
    ...
    private ASTNode ParsePrimary()
    {
        ...
        {
            var identifier = new Identifier(Previous().Value);
...
public class CSharpGenerator
{
    public SyntaxTree GenerateFromAST(Program program)
    {
        ...
        if (program.Statements.Any(s => s is FunctionDeclaration func && func.ReturnType.StartsWith("Result<")))
        {
            members.Add(GenerateResultClass());
        }
    ...
    private ExpressionSyntax GenerateExpression(ASTNode node)
    {
        return node switch
        {
            ...
            FunctionCall func => InvocationExpression(
